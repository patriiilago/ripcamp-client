    ...
    return (
        <div>
            <Container className='About'>
                <h1>Welcome to RipCamp®!</h1>
                <Row className="justify-content-md-center">
                    <Col>
                        <p>Welcome to our platform! We are Teresa Arranz and Patri Lago, both passionate students of web development, eager to make a positive impact in the tech community. Our journey began as classmates in a rigorous web development bootcamp, where we shared not only a common interest in coding but also a vision for fostering a strong and supportive network among fellow students and alumni.
